...
If you are running the app locally and sample data is available in your checkout, you can still use it for a quick offline walkthrough. The current primary workflow is public GitHub repository import.
